  ...
  app.get('/api/UWDC/', (req, res) => {
    ...
    axios.get('https://content-out.bepress.com/v2/digitalcommons.law.uw.edu/query?limit=5&q=' + DCuserrequest,{
      ...
      .then(function (response) {
        ...
        console.log('made it up to regex : ' + capresp3)
        let capresp4 = capresp3.replaceAll(/"download_format"[\s]*\][\s]*\}/g, '"download_format"]')
        console.log('made it past regex : ' + capresp4)
        let capresp5 = capresp4.replaceAll('"start"','"next"')
        console.log('made it past start-to-next : ' + capresp5)
